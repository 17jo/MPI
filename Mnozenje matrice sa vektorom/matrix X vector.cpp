// apri2023_a.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include<stdio.h>
#include "mpi.h"
#include<stdlib.h>
...
int main(int argc, char** argv) {
	...
	int* locA = (int*)calloc(l * k, sizeof(int)),
		* locB = (int*)calloc(l, sizeof(int)),
		* tmp = (int*)calloc(l, sizeof(int)),
		* rowsTmp = (int*)calloc(l, sizeof(int));
	...
	MPI_Comm_rank(rowsComm, &rowsRank);//rowID
	MPI_Comm_rank(colsComm, &colsRank);//colID
	...
	if (rank == min.rank) {
		printf("\nJa, proces %d, sadrzim najmanji element matrice A.\n", rank);
